...
GO
SET QUOTED_IDENTIFIER ON
CREATE TABLE [DB_ORDER_MANAGEMENT_SQL].[Role] (
	[Id] [uniqueidentifier] DEFAULT NEWID() NOT NULL,
...
GO
ALTER TABLE [DB_ORDER_MANAGEMENT_SQL].[Account]  WITH CHECK ADD  CONSTRAINT [PK_Account_Role] FOREIGN KEY([RoleId])
REFERENCES [DB_ORDER_MANAGEMENT_SQL].[Role] ([Id])
GO
ALTER TABLE [DB_ORDER_MANAGEMENT_SQL].[Account] CHECK CONSTRAINT [PK_Account_Role]
GO
ALTER TABLE [DB_ORDER_MANAGEMENT_SQL].[Account]  WITH CHECK ADD  CONSTRAINT [PK_Account_Employee] FOREIGN KEY([EmployeeId])
REFERENCES [DB_ORDER_MANAGEMENT_SQL].[Employee] ([Id])
GO
ALTER TABLE [DB_ORDER_MANAGEMENT_SQL].[Account] CHECK CONSTRAINT [PK_Account_Employee]
